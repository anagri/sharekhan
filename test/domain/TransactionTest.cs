...
namespace Sharekhan.domain
{
    ...
    public class TransactionTest : PersistenceTestBase
    {
        ...
        [Test,Ignore]
        public void ShouldBeAbleToGetTransactionsForInstrumentTillEndOfFinancialYear()
        {
            Instrument share = new Stock(new Symbol("REL"), new Price(10.00), "Reliance Power");
            Transaction buyTransaction1 = new BuyTransaction(new DateTime(2008, 06, 01), share, 10, new Price(10.00), 5.00, 3.00);
            Transaction sellTransaction1 = new SellTransaction(new DateTime(2008, 12, 01), share, 2, new Price(20.00), 5.00, 3.00);
        ...
        [Test,Ignore]
        public void ShouldBeAbleToCreateListOfTransactionsToCalculateShortTermCapitalGainFromCompleteListOfTransactionsForAnInstrument()
        {
            Instrument share = new Stock(new Symbol("REL"), new Price(10.00), "Reliance Power");
            Transaction buyTransaction1 = new BuyTransaction(new DateTime(2006, 06, 01), share, 20, new Price(10.00), 5.00, 3.00);
            Transaction sellTransaction1 = new SellTransaction(new DateTime(2006, 12, 01), share, 10, new Price(20.00), 5.00, 3.00);
            Transaction buyTransaction2 = new BuyTransaction(new DateTime(2007, 06, 01), share, 10, new Price(50.00), 5.00, 3.00);
            Transaction sellTransaction2 = new SellTransaction(new DateTime(2007, 12, 01), share, 5, new Price(100.00), 5.00, 3.00);

            Transaction buyTransaction3 = new BuyTransaction(new DateTime(2008, 06, 01), share, 10, new Price(10.00), 5.00, 3.00);
            Transaction buyTransaction4 = new BuyTransaction(new DateTime(2008, 12, 01), share, 10, new Price(20.00), 5.00, 3.00);
            Transaction sellTransaction3 = new SellTransaction(new DateTime(2009, 12, 01), share, 30, new Price(100.00), 5.00, 3.00);
